...
Первая версия датасета самая маленькая из трех. Она содержит специфический набор
...
Вторая версия датасета дополняет первую версию и включает в себя более разнообразные оттенки
...
Третья версия датасета дополняет вторую версию и включает в себя аугментации данных, такие как:
